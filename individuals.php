...
if(isset($_POST['submit'])){
    ...
    mysqli_query($db, "INSERT INTO individuals SET name = '$name', surname = '$surname', adress = '$adress', phone = '$phone'");
    header('Location: /lab7/Adress-book/individuals.php');
}
?>
...
<?php
$query = mysqli_query($db, "SELECT * FROM individuals");
